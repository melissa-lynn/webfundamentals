...
1. Each input should have a `name` attribute that you the programmer choose as part of designing the form. The corresponding `value` is either typed by the user or chosen from a set of possible values, as with `select` menus or radio buttons.
